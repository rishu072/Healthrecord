...
function HomeClient() {
    ...
    const handleAddAllergy = async () => {
        try {
            if (!allergy.name.trim() || !allergy.reaction.trim() || !allergy.type.trim()) {
                toast.error("Please fill in all allergy fields (Name, Reaction, and Severity).");
                return;
            }
            setLoading(true);
            ...
            if (res.success) {
                ...
                toast.error(res.message || "Unable to add Allergy");
            }
        } catch (error) {
            console.log(error);
    ...
    const handleAddChronic = async () => {
        try {
            if (!chronic.conditionName.trim() || !chronic.date.trim()) {
                toast.error("Please fill in the Condition Name and Date.");
                return;
            }
            setLoading(true);
            ...
            if (res.success) {
                ...
                toast.error(res.message || "Unable to add condition");
            }
        } catch (error) {
            console.log(error)
